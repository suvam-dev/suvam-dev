...
function Navbar() {
    ...
    return (
        <>
            <nav className="flex justify-between items-center  bg-light-100/80 backdrop-blur-sm text-blue-500 font-bold p-4 border-b-5 border-blue-500 fixed w-full max-md:realtive">
                ...
                <ul className={menu ? "absolute top-20  z-50 right-0 flex-col space-x-4 justify-end bg-gray-800" : "hidden md:flex space-x-4 justify-end"}>
                    <li className="text-blue-500 px-6 py-2 hover:bg-blue-500 hover:text-white">Home</li>
                    <li className="text-blue-500 px-6 py-2 hover:bg-blue-500 hover:text-white">Projects</li>
