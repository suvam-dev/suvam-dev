    ...
    return (
        <>
            <nav className="flex justify-between items-center  bg-light-100/80 backdrop-blur-sm text-blue-500 font-bold p-4 border-b-5 border-blue-500 fixed w-full max-md:realtive z-1000">
                ...
                <ul className={menu ? "absolute top-19  z-50 right-0 flex-col justify-end bg-gray-100/10 backdrop-blur-xl" : "hidden md:flex md:space-y-0 md:space-x-0 space-y-4 justify-end bg-light-100/80 backdrop-blur-sm"}>
